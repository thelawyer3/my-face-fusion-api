...
import cv2
import numpy
# Removed: from cv2.typing import Size
# Added: use Tuple[int, int] directly from typing
...
def estimate_matrix_by_face_landmark_5(face_landmark_5 : FaceLandmark5, warp_template : WarpTemplate, crop_size : Tuple[int, int]) -> Matrix:
...
def warp_face_by_face_landmark_5(temp_vision_frame : VisionFrame, face_landmark_5 : FaceLandmark5, warp_template : WarpTemplate, crop_size : Tuple[int, int]) -> Tuple[VisionFrame, Matrix]:
...
def warp_face_by_translation(temp_vision_frame : VisionFrame, translation : Translation, scale : float, crop_size : Tuple[int, int]) -> Tuple[VisionFrame, Matrix]:
...
def create_rotated_matrix_and_size(angle : Angle, size : Tuple[int, int]) -> Tuple[Matrix, Tuple[int, int]]:
