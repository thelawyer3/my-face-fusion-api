...
import cv2
import numpy
# Replaced: from cv2.typing import Size
# Instead, we use Tuple[int, int] for size
...
def create_static_box_mask(crop_size : Tuple[int, int], face_mask_blur : float, face_mask_padding : Padding) -> Mask:
