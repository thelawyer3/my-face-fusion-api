...
def create_tile_frames(vision_frame: VisionFrame, size: Tuple[int, int]) -> Tuple[List[VisionFrame], int, int]:
...
def merge_tile_frames(tile_vision_frames: List[VisionFrame], temp_width: int, temp_height: int, pad_width: int, pad_height: int, size: Tuple[int, int]) -> VisionFrame:
