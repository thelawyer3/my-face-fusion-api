...
from facefusion import (
    ...
    face_masker, face_recognizer, logger, process_manager, state_manager,
...
from facefusion.vision import (
    get_video_frame, pack_resolution, read_image, read_static_images,
    restrict_image_resolution, restrict_video_fps, restrict_video_resolution, unpack_resolution
)

# Function to check system requirements
def pre_check() -> bool:
    # Ensure Python version is at least 3.9
...
# Define additional functions like `force_download`, `route_job_manager`, `route_job_runner`, `process_image`, and `process_video` here...
# Rest of the code follows the provided template
